...
from stock_analysis.confidence_models.chart_patterns.rising_wedge_model import (
    load_model,
    learned_confidence,
    rising_wedge_score,
)
...
class RisingWedgeChartPattern(BasePattern):
    enabled = True
    ...
    def _run(self, df: pd.DataFrame) -> dict:
        ...
        rule_score = rising_wedge_score(
            high_pct_slope=high_pct,
            low_pct_slope=low_pct,
