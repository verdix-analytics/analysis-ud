...
import stock_analysis.confidence_models.chart_patterns.diamond_bottom_model as dbm
...
# Tests for diamond_bottom_score

def test_diamond_bottom_score_ideal_case_high_score():
    score = dbm.diamond_bottom_score(
...
def test_diamond_bottom_score_bad_case_low_score():
    score = dbm.diamond_bottom_score(
...
def test_diamond_bottom_score_boundary_center_levels():
    score1 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.90, 0.90, 0.95)
    score2 = dbm.diamond_bottom_score(0.75, 0.95, 0.95, 0.90, 0.90, 0.95)
    score3 = dbm.diamond_bottom_score(0.55, 0.95, 0.95, 0.90, 0.90, 0.95)
    score4 = dbm.diamond_bottom_score(0.35, 0.95, 0.95, 0.90, 0.90, 0.95)
...
def test_diamond_bottom_score_boundary_left_levels():
    score1 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.90, 0.90, 0.95)
    score2 = dbm.diamond_bottom_score(0.95, 0.75, 0.95, 0.90, 0.90, 0.95)
    score3 = dbm.diamond_bottom_score(0.95, 0.55, 0.95, 0.90, 0.90, 0.95)
    score4 = dbm.diamond_bottom_score(0.95, 0.35, 0.95, 0.90, 0.90, 0.95)
...
def test_diamond_bottom_score_boundary_right_levels():
    score1 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.90, 0.90, 0.95)
    score2 = dbm.diamond_bottom_score(0.95, 0.95, 0.75, 0.90, 0.90, 0.95)
    score3 = dbm.diamond_bottom_score(0.95, 0.95, 0.55, 0.90, 0.90, 0.95)
    score4 = dbm.diamond_bottom_score(0.95, 0.95, 0.35, 0.90, 0.90, 0.95)
...
def test_diamond_bottom_score_boundary_symmetry_levels():
    score1 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.90, 0.90, 0.95)
    score2 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.75, 0.90, 0.95)
    score3 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.60, 0.90, 0.95)
    score4 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.40, 0.90, 0.95)
...
def test_diamond_bottom_score_boundary_tightness_levels():
    score1 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.90, 0.90, 0.95)
    score2 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.90, 0.75, 0.95)
    score3 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.90, 0.55, 0.95)
    score4 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.90, 0.35, 0.95)
...
def test_diamond_bottom_score_boundary_pivot_richness_levels():
    score1 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.90, 0.90, 0.95)
    score2 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.90, 0.90, 0.75)
    score3 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.90, 0.90, 0.55)
    score4 = dbm.diamond_bottom_score(0.95, 0.95, 0.95, 0.90, 0.90, 0.35)
...
def test_sample_ranges_are_reasonable_for_outside():
    center_proximity_score, left_expansion_score, right_contraction_score, span_symmetry_ratio, boundary_tightness, pivot_richness_score = dbm._sample("outside")
